...
public class ClientesController {
    ...
    @FXML private TableColumn<Cliente, Double> colLimiteCredito;
    @FXML private TableColumn<Cliente, Double> colSaldoPendiente;
    ...
    @FXML private Label lblConCredito;
    @FXML private Label lblTotalCartera;
    ...
    private void actualizarCreditoDisponible() {
        try {
            double limite = txtLimiteCredito.getText().isEmpty() ? 0 : 
                           Double.parseDouble(txtLimiteCredito.getText());
            double saldo = txtSaldoPendiente.getText().isEmpty() ? 0 : 
                          Double.parseDouble(txtSaldoPendiente.getText());
    ...
    private void guardar() {
        ...
        try {
            ...
            if (exito) {
                mostrarMensajeExito(esNuevo ? "Cliente guardado exitosamente" : 
